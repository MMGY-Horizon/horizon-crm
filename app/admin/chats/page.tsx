      ...
      <div className="bg-white border-b border-gray-200 px-8 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Truckee-Tahoe • Live since August 2024</p>
          </div>
        </div>

        {/* Tabs */}
        <div className="flex gap-6 border-b border-gray-200">
          {['Dashboard', 'Chats', 'Places', 'Users', 'Settings', 'Team', 'Crawler', 'Create', 'Key Facts', 'Feedback', 'Web Integration'].map((tab) => (
            <button
              key={tab}
